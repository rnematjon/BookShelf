...
import com.oak.bookyourshelf.entity.dto.HeaderCategoryDTO;
...
public class AdminPanelCategoryService {
    ...
    public ArrayList<String> getAllSubcategoriesName(Category category) {
        return GlobalConstants.getAllSubcategories(category);
    }

    public ArrayList<Subcategory> getAllSubcategories(Category category) {
        return GlobalConstants.productDetailsGetAllSubcategories(category);
    }

...
public class SubcategoryController {
    ...
    public String showCategory(@RequestParam("page") Optional<Integer> page,
        ...
        if (!categoryIDList.get(0).equals("") && categoryIDList.size() == 1) {
            ...
            ArrayList<Subcategory> path = GlobalConstants.findPathBetweenSubcategoryAndCategory(category, subcategory);
            if (path.size() > 0) {
        ...
        GlobalConstants.getPageNumbers(page, size, booksMax, model, "subcategoryBooks");

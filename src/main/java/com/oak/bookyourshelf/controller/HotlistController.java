...
public class HotlistController {
    ...
    public HotlistController(HotListDetailsService hotListDetailsService) {
        this.hotListDetailsService = hotListDetailsService;
    }

    @RequestMapping(value = "/hotlist/{id}", method = RequestMethod.GET)
    public String showCategory(@RequestParam("page") Optional<Integer> page,
        ...
        GlobalConstants.getPageNumbers(page, size, booksMax, model, "hotlistBooks");

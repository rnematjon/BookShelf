...
import com.oak.bookyourshelf.entity.Book;
...
public class ElectronicBooksController {
    ...
    public ElectronicBooksController(CategoryService categoryService, ProductService productService) {
    ...
    public String showCategory(@RequestParam("page") Optional<Integer> page,
        ...
        categories.removeIf(category -> category.getProductType() != Category.ProductType.E_BOOK);
        ...
        GlobalConstants.getPageNumbers(page, size, booksMax, model, "categoryBooks");

...
import com.oak.bookyourshelf.entity.Campaign;
...
public class CampaignController {
    ...
    public String showCategory(@RequestParam("page") Optional<Integer> page,
        ...
        if (products.size() == 0) {
            GlobalConstants.getPageNumbers(page, size, booksMax, model, "campaignBooks");
        } else {
            GlobalConstants.getPageNumbers(page, size, products, model, "campaignBooks");
        }

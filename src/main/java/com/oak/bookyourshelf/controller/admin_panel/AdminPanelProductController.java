...
public class AdminPanelProductController {
    ...
    public String tab(@RequestParam("page") Optional<Integer> page,
        ...
        GlobalConstants.getPageNumbers(page, size, filterProducts(adminPanelProductService.sortProducts(currentSort), currentFilter), model, "productPage");
    ...
    public List<String> findAllSubcategories(@RequestParam String category) {
        List<String> subcategories = GlobalConstants.getAllSubcategories(adminPanelCategoryService.getByName(category));
